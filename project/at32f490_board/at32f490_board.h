...
#ifndef __AT32F490_BOARD_H
#define __AT32F490_BOARD_H
...
/**
  ...
  *   1. at-start-f490 v1.x board
  * if define AT_START_F490_V1, the header file support at-start-f490 v1.x board
  */

#if !defined (AT_START_F490_V1)
#error "please select first the board at-start device used in your application (in at32f490_board.h file)"
#endif
